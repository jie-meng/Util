...
void TestCaseMemory::testMemory()
{
    ...
    assertEquals<size_t>(0, mem0.length(), ASSERT_POSITION);
    ...
    assertEquals<size_t>(20, mem0.length(), ASSERT_POSITION);
    ...
    assertEquals<size_t>(0, mem1.length(), ASSERT_POSITION);
    ...
    assertEquals<size_t>(20, mem1.length(), ASSERT_POSITION);
    ...
    assertEquals<size_t>(10, mem2.length(), ASSERT_POSITION);
...
void TestCaseMemory::testMemoryBuf()
{
    Memory<char> mem(5);
    strcpy(mem.buf(), "test");
    assertEquals<size_t>(5, mem.length(), ASSERT_POSITION);
    ...
    assertEquals<size_t>(5, mem2.length(), ASSERT_POSITION);
